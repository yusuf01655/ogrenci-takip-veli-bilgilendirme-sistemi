...
const API_URL = 'http://localhost:5000/api/ogrencinotlarindan';
                    ...
                    isMobile ? (
                        ...
                        <Grid container spacing={2}>
                            {ogrenciler.length === 0 ? (
                                ...
                                ogrenciler.map((ogrenci_not) => (
                                    <Grid item xs={12} key={ogrenci_not.id}>
                                        <Card variant="outlined" className="ogrenci-kart">
                                            <CardContent>
                                                <Typography variant="h6" gutterBottom>{ogrenci_not.id}</Typography>
                                                <Typography color="textSecondary">Numara: {ogrenci_not.ogrenci_id}</Typography>
                                                <Typography color="textSecondary">Sınıf: {ogrenci_not.ders_id || '-'}</Typography>
                                                <Typography color="textSecondary">Veli ID: {ogrenci_not.sinav1 || '-'}</Typography>
                                                <Typography color="textSecondary">Veli ID: {ogrenci_not.sinav2 || '-'}</Typography>
                                ...
                                <Table stickyHeader className="ogrenci-tablosu" aria-label="Öğrenci Listesi Tablosu">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell>ders_id</TableCell>
                                            <TableCell>sinav1</TableCell>
                                            <TableCell>sinav2</TableCell>
                                    ...
                                    <TableBody>
                                        {ogrenciler.length === 0 ? (
                                            ...
                                            ogrenciler.map((ogrenci_not) => (
                                                <TableRow key={ogrenci_not.id} hover>
                                                    <TableCell>{ogrenci_not.id}</TableCell>
                                                    <TableCell>{ogrenci_not.ogrenci_id}</TableCell>
                                                    <TableCell>{ogrenci_not.ders_id}</TableCell>
                                                    <TableCell>{ogrenci_not.sinav1}</TableCell>
                                                    <TableCell>{ogrenci_not.sinav2}</TableCell>
                                                    
                                                    <TableCell align="right">
                                                        <IconButton
                                                            size="small"
                                                            onClick={() => handleOpenDialog(ogrenci_not)}
                                                            className="edit-icon"
                                                            aria-label={`Düzenle bildirim ${ogrenci_not.id}`}
                                                            sx={{ mr: 1 }}
                                                        >
                                                        ...
                                                        <IconButton
                                                            size="small"
                                                            onClick={() => handleOpenDeleteConfirm(ogrenci_not)}
                                                            className="delete-icon"
                                                            aria-label={`Sil bildirim ${ogrenci_not.id}`}
                                                        >
