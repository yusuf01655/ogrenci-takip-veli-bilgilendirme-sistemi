...
const ogrenciNotlarindanRoutes = require('./routes/ogrenciNotlarindanRoutes'); // Öğrenci notlarından rotalar
const app = express();
...
app.use('/api/ogrencinotlarindan',ogrenciNotlarindanRoutes);
